...
export const BellIcon = ({ ringing }) => (
  /* Fixed the text-(--muted) syntax typo here */
  <svg className={`w-3.75 h-3.75 ${ringing ? 'text-[var(--light-red)] animate-wiggle' : 'text-[var(--muted)]'} `} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"></path>
    <path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"></path>
  </svg>
);

// FIXED: Now accepts `isDark` prop and swaps between Sun and Moon shapes dynamically
export const SunMoonIcon = ({ isDark }) => {
  if (isDark) {
    // Returns Moon Icon paths
    return (
      <svg className="text-[var(--primary-color)] w-[15px] h-[15px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
      </svg>
    );
  }

  // Returns Sun Icon paths (Default fallback)
  return (
    <svg className="text-[var(--muted)] w-[15px] h-[15px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="4"></circle>
      <path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"></path>
    </svg>
  );
